                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <p class="mb-0"><?= $transaction['created_by_name'] ?: 'System' ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card mt-4">
                                ...
                                <div class="card-body">
                                    <div class="d-grid gap-2">
                                        <a href="<?= base_url('admin/edit_transaction/' . $transaction['id']) ?>" 
                                           class="btn btn-outline-primary">
                                            <i class="fas fa-edit me-2"></i>
                                            Edit Transaksi
                                        </a>
                                        <a href="<?= base_url('admin/delete_transaction/' . $transaction['id']) ?>" 
                                           class="btn btn-outline-danger"
                                           onclick="return confirm('Apakah Anda yakin ingin menghapus transaksi ini?')">
                                            <i class="fas fa-trash me-2"></i>
                                            Hapus Transaksi
                                        </a>
                                        <a href="<?= base_url('admin/print_transaction/' . $transaction['id']) ?>" 
